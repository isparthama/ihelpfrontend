    ...
    <form method="post" action="<?php echo base_url('lk3');?>"  enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="formGroupunit">Facility</label>
                <div id="elunit">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <div id="eljeniscomplainid">
                    ...
                    <input type="hidden"   id="tipecategory" name="tipecategory">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <div id="elnote">
                    <input class="form-control" type='text' id='note' name='note' value=''  required>
                </div>
